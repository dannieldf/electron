...
class File extends Component
{
    ...
    trashItemClick(file_index)
    {
        ...
        if (!this.multiple && this.trash_menu)
        {
            this.trash_menu.close()
        }
        if (typeof this.onadd == 'function')
        {
            for (i in this.files)
...
class Recordset
{
    ...
    {
        var i, object, handle
        handle = this.records[row]
        object = {}
        for (i in this.fields)
        {
            object[this.fields[i]] = handle[i]
        }
        return object
    }
    ...
    {
        var i, j, defaults, fields, records, recordset
        fields = {}
        records = {}
        defaults =
            {
